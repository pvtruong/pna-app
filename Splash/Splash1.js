...
import {Text,Icon,Thumbnail,Input,Button,H3,H1,H2} from 'native-base';
    ...
    return (
      <Content scrollable={false}>
        <View style={{flexGrow:1}}>
          <Image source={require("../assets/splash1.png")} style={{height:viewportHeight/2,width:viewportWidth}}/>
          ...
          <Text style={{textAlign:"center",marginTop:30,paddingLeft:10,paddingRight:10}}>{getLabel("Hệ thống dịch vụ chăm sóc sức khỏe cho người cao tuổi")}</Text>
        </View>
        <View style={{flexDirection:"row",justifyContent:"space-between"}}>
          ...
          <View style={{flexGrow:1,flexDirection:"row",justifyContent:"center",alignItems:"center"}}>
            <View style={{width:5,height:5,backgroundColor:"black",borderRadius:5/2}}></View>
            <View style={{width:5,height:5,marginLeft:5,backgroundColor:"silver",borderRadius:5/2}}></View>
            <View style={{width:5,height:5,marginLeft:5,backgroundColor:"silver",borderRadius:5/2}}></View>
          </View>
          <Button transparent onPress={()=>this.navigate("Splash2")}>
