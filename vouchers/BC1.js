...
class BC1 extends React.Component {
  ...
  async componentDidMount(){
    this.mounted = true;
    try{
      let voucherInfo = await asyncGetVoucherInfo(this.context.userInfo.token,"BC1",this.context.userInfo.email);
