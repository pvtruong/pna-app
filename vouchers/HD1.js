...
class HD1 extends React.Component {
  ...
  async componentDidMount(){
    this.mounted = true;
    try{
      let voucherInfo = await asyncGetVoucherInfo(this.context.userInfo.token,"HD1",this.context.userInfo.email);
  ...
  render() {
    ...
    return (
      <Voucher navigation = {this.props.navigation}
        title={getLabel("Hoá đơn bán dịch vụ")}
