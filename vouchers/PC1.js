...
class PC1 extends React.Component {
  ...
  async componentDidMount(){
    this.mounted = true;
    try{
      let voucherInfo = await asyncGetVoucherInfo(this.context.userInfo.token,"PC1",this.context.userInfo.email);
