...
class PN1 extends React.Component {
  ...
  async componentDidMount(){
    this.mounted = true;
    try{
      let voucherInfo = await asyncGetVoucherInfo(this.context.userInfo.token,"PN1",this.context.userInfo.email);
  ...
  render() {
    ...
    return (
      <Voucher navigation = {this.props.navigation}
        title={getLabel("Phiếu nhập mua hàng")}
